...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post physicians_url, params: { physician: { name: @physician.name, office_id: @physician.office_id, specialty: @physician.specialty } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { name: @physician.name, office_id: @physician.office_id, specialty: @physician.specialty } }
